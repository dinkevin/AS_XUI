...
/**
 * 汉字转换器 </br>
 * Created by Chengpengfei on 2016/10/24 0024.
 */

public class CharacterParser {

    private static int[] pingYinValue = new int[] {-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    public static String[] pingYinKey = new String[] {"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
    ...
    public String convert(String str) {
        ...
        if (ascii > 0 && ascii < 160) {
            ...
            for (int i = (pingYinValue.length - 1); i >= 0; i--) {
                if (pingYinValue[i] <= ascii) {
                    result = pingYinKey[i];
                    break;
                }
            }
