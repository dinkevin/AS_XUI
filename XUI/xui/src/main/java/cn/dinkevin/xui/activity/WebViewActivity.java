...
public class WebViewActivity extends AbstractActivity {
	...
	protected void onCreate(Bundle savedInstance) {
		...
		img_headLeft.setImageResource(R.mipmap.xui_action_back_white);
		...
		progress_bar.setProgressColor(getResources().getColor(R.color.xui_text_blue_81ccea));
		progress_bar.setNormalColor(getResources().getColor(R.color.xui_white));
	...
	protected class MyWebViewClient extends WebViewClient{
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			LogUtil.d("webView load url:"+url);
